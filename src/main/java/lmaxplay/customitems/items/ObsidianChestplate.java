...
public class ObsidianChestplate implements CustomItem {
    @Override
    public String getName() {
        return "§9Obsidian Chestplate";
    }
    ...
    public ItemStack createItemStack() {
        ItemStack itemStack = new ItemStack(org.bukkit.Material.NETHERITE_CHESTPLATE);
